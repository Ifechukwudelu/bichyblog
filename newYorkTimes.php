...
<head>
    ...
    <title>Old New York Times • Bichy Blog</title>
...
<body class="bg-[#dadada] text-[#131313]">
    ...
    <nav class="fixed top-0 z-50 w-full border-b border-[#131313] bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-4 flex items-center justify-between py-3">
            <div class="flex items-center gap-2">
                ...
                <h1 class="text-2xl font-bold tracking-wide">Old New York Times</h1>
            </div>
            <div class="flex items-center gap-4">
                <form method="GET" action="newYorkTimes.php">
    ...
    <main class="pt-28 max-w-6xl mx-auto px-6">
        ...
        <section class="mb-12 text-center">
            <h2 class="text-4xl font-bold typewriter">Old New York Times</h2>
            <p class="mt-2 text-sm opacity-70 tracking-widest uppercase">— Historical scenes and classic tales from the
                big city —</p>
        </section>
        ...
        <section class="mb-16 bg-[#f7f5ee] p-6 border border-[#131313] shadow-sm leading-loose">
            <p class="text-lg" style="font-family:'Libre Baskerville', serif;">
                Step into the heart of Manhattan as it once was. The Old New York Times captures the pulse of the city,
                showcasing bustling streets, historic architecture, and stories of people who shaped the city’s
                character.
                From grand boulevards to intimate cafés, experience the charm and drama of a bygone era.
            </p>
            <p class="text-lg mt-4" style="font-family:'Libre Baskerville', serif;">
                This collection of historical snapshots and classic tales invites you to wander through New York’s past,
                celebrating the vibrancy, ambition, and timeless elegance that defined the Big Apple before the modern
                age.
            </p>
        </section>
        ...
        $query = "SELECT post_id, title, content, image_path FROM posts 
                    WHERE status = 'approved' AND category = 'oldNewYork'
                    ORDER BY created_at DESC";
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
            ...
            style="background-image:url('user/<?= htmlspecialchars($row['image_path']); ?>')"></div>
                ...
                <a href="article.php?id=<?= $row['post_id']; ?>&from=newYorkTimes.php"> 
